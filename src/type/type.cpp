...
bool Type::IsTrue(const Value &val) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(TypeToString(type_id_) + " doesn't implement IsTrue");
}

bool Type::IsFalse(const Value &val) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(TypeToString(type_id_) + " doesn't implement IsFalse");
}
...
CmpBool Type::CompareEquals(const Value &left, const Value &right) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(Type::TypeToString(type_id_) + " doesn't implement compare equals");
    
}

CmpBool Type::CompareNotEquals(const Value &left, const Value &right) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(Type::TypeToString(type_id_) + " doesn't implement compare not equals");
}

CmpBool Type::CompareLessThan(const Value &left, const Value &right) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(Type::TypeToString(type_id_) + " doesn't implement compare less than");
}

CmpBool Type::CompareLessThanEquals(const Value &left, const Value &right) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(Type::TypeToString(type_id_) + " doesn't implement compare less than equals");
}

CmpBool Type::CompareGreaterThan(const Value &left, const Value &right) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(Type::TypeToString(type_id_) + " doesn't implement compare greater than");
}

CmpBool Type::CompareGreaterThanEquals(const Value &left, const Value &right) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(Type::TypeToString(type_id_) + " doesn't implement compare greater than equals");
}

Value Type::Add(const Value &left, const Value &right) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(Type::TypeToString(type_id_) + " doesn't implement add");
}

Value Type::Subtract(const Value &left, const Value &right) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(Type::TypeToString(type_id_) + " doesn't implement subtract");
}

Value Type::Multiply(const Value &left, const Value &right) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(Type::TypeToString(type_id_) + " doesn't implement multiply");
}

Value Type::Divide(const Value &left, const Value &right) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(Type::TypeToString(type_id_) + " doesn't implement divide");
}

Value Type::Modulo(const Value &left, const Value &right) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(Type::TypeToString(type_id_) + " doesn't implement modulo");
}

Value Type::Min(const Value &left, const Value &right) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(Type::TypeToString(type_id_) + " doesn't implement min");
}
 
Value Type::Max(const Value &left, const Value &right) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(Type::TypeToString(type_id_) + " doesn't implement max");
}
 
Value Type::Sqrt(const Value &val) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(Type::TypeToString(type_id_) + " doesn't implement sqrt");
}
 
Value Type::OperateNull(const Value &val, const Value &right) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(Type::TypeToString(type_id_) + " doesn't implement operate null");
}

bool Type::IsZero(const Value &val) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(Type::TypeToString(type_id_) + " doesn't implement is zero");
}

bool Type::IsInlined(const Value &val) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(Type::TypeToString(type_id_) + " doesn't implement is inlined");
}

std::string Type::ToString(const Value &val) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(Type::TypeToString(type_id_) + " doesn't implement to string");
}

std::string Type::SerializeToString(const Value &val) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(Type::TypeToString(type_id_) + " doesn't implement serialize to string");
}

Value Type::DeserializeFromString(const std::string &data) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(Type::TypeToString(type_id_) + " doesn't implement deserialize from string");
}

void Type::SerializeTo(const Value &val, char *storage) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(Type::TypeToString(type_id_) + " doesn't implement serialize to");
}

Value Type::DeserializeFrom(const char *storage) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(Type::TypeToString(type_id_) + " doesn't implement deserialize from");
}

Value Type::Copy(const Value &val) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(Type::TypeToString(type_id_) + " doesn't implement copy");
}

Value Type::CastAs(const Value &val, TypeId type_id) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(Type::TypeToString(type_id_) + " doesn't implement cast as");
}

const char *Type::GetData(const Value &val) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(Type::TypeToString(type_id_) + " doesn't implement get data");
}

uint32_t Type::GetLength(const Value &val) const {
    THROW_NOT_IMPLEMENTED_EXCEPTION(Type::TypeToString(type_id_) + " doesn't implement get length");
}
